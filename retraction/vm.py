...
# from retraction.types import Type  # CAST_PRIORITY, SIZE_BYTES,
...
#     if t == Type.CARD_T or t == Type.INT_T:
#         return value % 0x10000
#     elif t == Type.BYTE_T or t == Type.CHAR_T:
#         return value % 0x100
...
#     def __init__(self, code: bytearray, symbol_table: SymbolTable | None = None):
...
#         operand1_t = Type(self.memory[self.pc + 1])
#         operand2_t = Type(self.memory[self.pc + 2])
...
#                 self.pc += 4 if SIZE_BYTES[constant_t.value] == 2 else 3
...
#                 self.params_size += SIZE_BYTES[value_t.value]
...
#                 self.push(params_size, Type.CARD_T)
#                 # Push return address
#                 self.push(self.pc + 8, Type.CARD_T)
#                 # Push frame pointer
#                 self.push(self.frame_ptr, Type.CARD_T)
...
#                 # Pop frame pointer
#                 self.frame_ptr = self.pop(Type.CARD_T)
#                 # Pop return address
#                 self.pc = self.pop(Type.CARD_T)
#                 # Pop params size
#                 self.pop(Type.CARD_T)
#                 # Push return value
